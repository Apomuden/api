        ...
        // get user role permissions
           ...
           if(!$role || $role->status!='ACTIVE')
               ...
               return $next($request);
                ...
                if(!$module || !$component)
                 return $next($request);
                else if((ApiRequest::endsWith($name,'index')|| ApiRequest::endsWith($name, 'view'))&&((isset($componentParts[1]) && $componentParts[1]=='free')|| (isset($componentParts[0]) && $componentParts[0] == 'free')))
                return $next($request);
                else{
