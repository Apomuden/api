...
class DiscountRequest extends FormRequest
{
    ...
    public function rules()
    {
        ...
        return [
            ...
            'total_bill'=>'bail|'.(($id || !$discount_percentage) ?'sometimes':'required').'|numeric|min:1',
            'discount_amount'=>'bail|'.(($id || $discount_percentage)?'sometimes':'required').'|numeric|min:1',
            'discount_percentage'=>'bail|sometimes|numeric|min:1',
