...
class ConsultationRequest extends ApiFormRequest
{
    ...
    public function rules() : array
    {
        ...
        return [
            ...
            'member_id'=>'bail|'.(!$id && ($sponsorship_type==='government insurance' || $sponsorship_type==='private insurance') ?'required':'sometimes|nullable').'|integer|exists:patient_sponsors,member_id',
