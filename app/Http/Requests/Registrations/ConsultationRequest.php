...
class ConsultationRequest extends ApiFormRequest
{
    ...
    public function rules() : array
    {
        ...
        return [
            ...
            'billing_sponsor_id'=>'bail|'.($id || ($sponsorship_type=='patient' || $sponsorship_type=='government insurance') ?'sometimes|nullable':'required').'|string|exists:billing_sponsors,id',
