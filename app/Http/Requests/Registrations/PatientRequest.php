...
class PatientRequest extends ApiFormRequest
{
   ...
   public function rules(){
        ...
        return [
            ...
            'country_id'=>'bail|sometimes|nullable|integer|exists:countries,id',
            'region_id'=>'bail|sometimes|nullable|integer|exists:regions,id',
            'district_id'=>'bail|sometimes|nullable|integer|exists:districts,id',
            ...
            'id_no'=>'bail|'.($id_type_id ?'required':'sometimes|nullable').'|unique:patients,id_no'.($id?','.$id:''),
