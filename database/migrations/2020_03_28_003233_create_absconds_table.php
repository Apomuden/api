...
class CreateAbscondsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('absconds', function (Blueprint $table) {
            ...
            $table->decimal('abscond_amount', 20, 2)->default(0);
            $table->timestamp('abscond_date')->useCurrent();
