...
class CreatePhysicalExaminationsTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('physical_examinations', function (Blueprint $table) {
            ...
            $table->unsignedBigInteger('physical_examination_type_id');
            $table->foreign('physical_examination_type_id')->references('id')->on('physical_examination_types')->onDelete('restrict');
