...
class CreateTreatmentPlanNotesTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('treatment_plan_notes', function (Blueprint $table) {
            ...
            $table->uuid('consultant_id')->nullable()->comment('The doctor/nurse writing the note');
    ...
    {
        Schema::dropIfExists('treatment_plan_notes');
    }
}
