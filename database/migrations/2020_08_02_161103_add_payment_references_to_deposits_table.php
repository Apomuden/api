...
class AddPaymentReferencesToDepositsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::table('deposits', function (Blueprint $table) {
            ...
            $table->string('api_internal_ref')->after('deposit_amount')->index()->nullable();
            ...
            $table->unsignedInteger('bank_id')->after('payment_channel_id')->nullable();
