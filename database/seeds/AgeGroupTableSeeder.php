...
class AgeGroupTableSeeder extends Seeder
{
    ...
    {
        AgeGroup::insert([
            ['name'=>'Infant','duration_type'=>'MONTH','min_age'=>3,'max_age'=>12],
            ['name'=>'Baby','duration_type'=>'MONTH','min_age'=>0,'max_age'=>2],
            ['name'=>'Child','duration_type'=>'YEAR','min_age'=>2,'max_age'=>17],
